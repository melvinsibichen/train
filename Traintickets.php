...
<body background="photo/pic1.jfif">
    <b style="color: lightcyan;font-weight:900;"><center><h3>Search Train</h3></center></b>
    
    <div class="container">
        <div style="background-color: rgb(130, 138, 138);" class="row">
        <div class="col col-12 col-sm-12 col-md-8 col-lg-6 col-xl-12 col-xxl-12">
            <table class="table table-borderless">
                <tr>
                    <td style="font-weight: 500;">From</td>
                    <td><input type="text" class="form-control"></td>
                    <td style="font-weight: 500;">To</td>
                    <td><input type="text" class="form-control"></td>
                    <tds tyle="font-weight: 500;">Date</td>
                    <td><input type="date" class="form-control"></td>
                    <td style="font-weight: 500;"><button class="btn btn-primary">Search Train</button></td>
                </tr>
            </table>
            </div>
